...
const RootLayout = () => {
    ...
    return (
        <GestureHandlerRootView style={{ flex: 1 }}>
            <AuthProvider>
                <Stack>
                    {/* These three are layout routes. Expo Router handles them automatically.
                        We can remove them from here to resolve the warnings. */}
                    <Stack.Screen name='index' options={{ headerShown: false }} />
                    <Stack.Screen name="(auth)" options={{ headerShown: false }} />
                    <Stack.Screen name="(tabs)" options={{ headerShown: false }} />
                    
                    {/* We only need to list screens here if we want to customize their options
                        at the ROOT level, which you are doing correctly. */}
                    <Stack.Screen name="my-profile/index" options={{ headerShown: false }} />
                    <Stack.Screen name="leave-tracker" options={{ headerShown: false }} />
                    ...
                    />
                    <Stack.Screen
                        name="raise-regularize-request/[date]"
                        options={{
